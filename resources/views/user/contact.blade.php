    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">Beri Kami Kritik dan Saran</h1>
            </div>
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <h5>Get In Touch</h5>
                    <p class="mb-4">Belum puas dengan layanan yang ada atau ada saran? Kamu bisa kirimkan keluh
                        kesah dan saranmu menggunakan website ini di sini. <a
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="mb-0">jasain@gmail.com</p>
                        </div>
                    </div>
                </div>
